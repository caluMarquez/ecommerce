        ...
        <Helmet title={productName}>
                    ...
                    <Row>
                        ...
                        <Col lg='6'>
                            <div className="product__details">
                                <h2>{productName}</h2>
                                <div className="product__rating d-flex align-items-center gap-g mb-3">
                                    <div>
                                        <span>
            ...
            <section>
                            ...
                            <div className="reviews__wrapper">
                                ...
                                <div className="review__form">
                                    ...
                                    <form action='' onSubmit={submitHandler}>
                                        ...
                                        <div className="form__group">
                                            <textarea rows={4}  type="text" ref={reviewMsg} required   placeholder='Review Message..' />
                ...
                <Col lg='12' className='mt-5'>
                    <h2 className="related__title">Yoy might also like</h2>
                </Col>
