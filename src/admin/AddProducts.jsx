...
const addProduct = async e=>{
    ...
    setLoading(true)
      ...
      //agregar a la database de firebase
                    ...
                    <Col lg='12'>
                        ...
                        <Form onSubmit={addProduct}>
                            ...
                            <FormGroup className="form__group">
                                ...
                                <input type="text" placeholder='lorem...' value={shortDescp} onChange={e=>setShortDescp(e.target.value)} required/>
                            </FormGroup>
                            ...
                            <FormGroup className="form__group w-50">
                                <span>Price</span>
                                <input type="numer" placeholder='$100' value={enterPrice} onChange={e=>setEnterPrice(e.target.value)} required/>
                            </FormGroup>
